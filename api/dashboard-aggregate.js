// --- FINAL: Supabase-driven aggregate (max 3 dagen) ---
// Leest geaggregeerde rijen uit Supabase (lead_uniques_day_grp) en bouwt
// boom: dag -> affiliate -> offer. Campagne 925 is overal uitgesloten.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Query op materialized table/view 'lead_uniques_day_grp'
    ...
    if (sub_id) p.append('sub_id', `eq.${sub_id}`); // alleen als aanwezig in je view
    ...
    // Boom bouwen: dag -> affiliate -> offer
